   ...
   <table id="dg" title="未完成订单列表" class="easyui-datagrid" style="width:550px;height:250px"
	...
	<thead>
		<tr>
			...
			<th field="orderEnd" width="50" sortable="true">结束时间</th>
		</tr>
	</thead>
</table>
<div id="toolbar">
	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editOrder()">修改</a>
	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="delOrder()">删除</a>
	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-sum" plain="true" onclick="freeOrder()">免单</a>
</div>
<!-- 创建修改的表单对话框 -->
